...
define("_phptelemeter_parser_simulator", "1");
/*

phpTelemeter - a php script to read out and display ISP's usage-meter stats.

parser_simulator.inc.php - file which contains the simulator module.
...
class telemeterParser_simulator extends telemeterParser_web_shared
{
	var $_ISP = "simulator";
